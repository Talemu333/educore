...
const getMyResultReport = asyncHandler(async (req,res)=>{const data=await studentResultService.getStudentResultReport(req.user.student_id,req.params.sessionId,req.params.termId,getSchoolId(req));res.json({success:true,data});});
...
module.exports={createResult,createBulkResults,getStudentsForAssignment,getStudentsForResultEntry,getStudentResultReport,getMyResultReport,getClassResultSheet,getClassBroadsheet};
