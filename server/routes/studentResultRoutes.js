...
router.get("/my/session/:sessionId/term/:termId/report", authenticate, authorize(ROLES.STUDENT), studentResultController.getMyResultReport);
router.get("/student/:studentId/session/:sessionId/term/:termId/report", authenticate, authorize(ROLES.ADMIN, ROLES.TEACHER, ROLES.PARENT), studentResultController.getStudentResultReport);
