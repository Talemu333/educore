            ...
            <div className="flex min-h-[70vh] items-center justify-center px-4">
                <div className="max-w-lg text-center">
                    ...
                    <p className="mt-4 text-sm leading-6 text-slate-500">
                        The event you are looking for could not be found or is no longer available.
                    </p>
                    <Link
                        to="/events"
        ...
        <article>
                    ...
                    <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
                        {formattedDate && (
                            <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                                ...
                                <p className="mt-4 text-xs font-bold uppercase tracking-wider text-slate-500">Date</p>
                                <p className="mt-2 text-sm font-semibold leading-6 text-slate-900">{formattedDate}</p>
                            </div>
                        )}
                        ...
                        {eventTime && (
                            <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                                ...
                                <p className="mt-4 text-xs font-bold uppercase tracking-wider text-slate-500">Time</p>
                                <p className="mt-2 text-sm font-semibold leading-6 text-slate-900">{eventTime}</p>
                            </div>
                        )}
                        ...
                        {event.venue && (
                            <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                                ...
                                <p className="mt-4 text-xs font-bold uppercase tracking-wider text-slate-500">Venue</p>
                                <p className="mt-2 text-sm font-semibold leading-6 text-slate-900">{event.venue}</p>
                            </div>
                        )}
                        ...
                        {event.organizer && (
                            <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                                ...
                                <p className="mt-4 text-xs font-bold uppercase tracking-wider text-slate-500">Organizer</p>
                                <p className="mt-2 text-sm font-semibold leading-6 text-slate-900">{event.organizer}</p>
                            </div>
                        )}
                    </div>
                </div>
            ...
            <section className="px-4 pb-16 sm:px-6 sm:pb-20 lg:px-8">
                <div className="mx-auto max-w-3xl">
                    ...
                    {event.content ? (
                        <div className="mt-8 whitespace-pre-line text-base leading-8 text-slate-700 sm:text-lg sm:leading-9">
                            {event.content}
                        </div>
                    ) : event.description ? (
                        <div className="mt-8 whitespace-pre-line text-base leading-8 text-slate-700 sm:text-lg sm:leading-9">
