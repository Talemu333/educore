            ...
            <Card>
                <CardContent className="p-5 sm:p-7">
                    ...
                    <form onSubmit={saveExam} className="grid gap-4 md:grid-cols-2">
                        ...
                        <select className="rounded-lg border p-3" value={exam.status} onChange={(e) => setExam({ ...exam, status: e.target.value })}><option value="draft">Draft</option><option value="published">Published</option><option value="archived">Archived</option></select>
