...
function ExpensesPage() {
    ...
    } = useExpenseSummary(summaryFilters);
    ...
    const handleDelete = expense => {
        if (!window.confirm(
            `Delete this expense of ${formatMoney(expense.amount)}? This action cannot be undone.`
        )) {
            return;
        }
    ...
    if (isLoading || isSummaryLoading) {
        return <Loading message="Loading expense records..." />;
    }
        ...
        <div className="space-y-6">
            ...
            <section className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
                <div className="app-surface p-5">
                    ...
                    <p className="mt-4 text-sm font-medium text-slate-500">Total Expenses</p>
                ...
                <div className="app-surface p-5">
                    ...
                    <p className="mt-4 text-sm font-medium text-slate-500">Transactions</p>
                    <p className="mt-1 text-2xl font-bold text-slate-900">
                ...
                <div className="app-surface p-5">
                    ...
                    <p className="mt-4 text-sm font-medium text-slate-500">Average Expense</p>
                    <p className="mt-1 text-2xl font-bold text-slate-900">
                        {formatMoney(summary?.average_amount)}
                    </p>
                </div>
                ...
                <div className="app-surface p-5">
                    ...
                    <p className="mt-4 text-sm font-medium text-slate-500">Highest Expense</p>
                    <p className="mt-1 text-2xl font-bold text-slate-900">
                        {formatMoney(summary?.highest_amount)}
                    </p>
                </div>
            </section>
            ...
            <section className="app-surface overflow-hidden">
                ...
                {isError ? (
                    <div className="p-8 text-center text-sm text-red-600">
                        Unable to load expense records. Please try again.
                    </div>
                ) : expenses.length === 0 ? (
                    <div className="p-12 text-center">
                        ...
                        <h3 className="mt-4 text-sm font-semibold text-slate-900">No expenses found</h3>
                        <p className="mx-auto mt-1 max-w-sm text-sm text-slate-500">
                            Record your school's first expense or adjust the filters above.
                        </p>
                        <button
                            type="button"
                            onClick={openCreateForm}
                        ...
                        <table className="min-w-full divide-y divide-slate-200">
                            <thead className="bg-slate-50">
                                <tr>
                                    ...
                                    <th className="px-5 py-3 text-left text-xs font-semibold uppercase tracking-wide text-slate-500">Vendor</th>
                                    ...
                                    <tr key={expense.id} className="transition hover:bg-slate-50/80">
                                        ...
                                        <td className="max-w-xs px-5 py-4 text-sm text-slate-700">
                                            ...
                                            {expense.reference_number && (
                                                <div className="mt-1 text-xs text-slate-400">Ref: {expense.reference_number}</div>
                                            )}
                                        </td>
                                        ...
                                        <td className="whitespace-nowrap px-5 py-4 text-right">
                                            <div className="flex justify-end gap-2">
                                                <button
                                                    ...
                                                    className="inline-flex h-9 w-9 items-center justify-center rounded-lg border border-slate-200 text-slate-500 hover:bg-slate-100 hover:text-slate-800"
                                                    title="Edit expense"
                                                >
                                                ...
                                                <button
                                                    ...
                                                    className="inline-flex h-9 w-9 items-center justify-center rounded-lg border border-red-100 text-red-500 hover:bg-red-50 hover:text-red-700 disabled:opacity-50"
                    ...
                    <div className="max-h-[92vh] w-full max-w-2xl overflow-y-auto rounded-2xl bg-white shadow-2xl">
                        <div className="flex items-center justify-between border-b border-slate-200 px-5 py-4 sm:px-6">
                            <div>
                                ...
                                <p className="mt-1 text-sm text-slate-500">
                                    Keep a clear record of money spent by the school.
                                </p>
                            </div>
                            <button
                                type="button"
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5 p-5 sm:p-6">
                            ...
                            <div className="flex flex-col-reverse gap-3 border-t border-slate-200 pt-5 sm:flex-row sm:justify-end">
                                <button
                                    ...
                                    onClick={closeForm}
                                    disabled={isSaving}
                                    className="rounded-lg border border-slate-300 px-4 py-2.5 text-sm font-semibold text-slate-600 hover:bg-slate-50 disabled:opacity-50"
                                >
                                    Cancel
                                </button>
                                <button
